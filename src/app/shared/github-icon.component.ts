...
/**
 * Reusable GitHub octocat SVG icon.
 * Replaces 6+ duplicate inline SVG copies across the app.
 */
@Component({
    ...
    template: `
    <svg [attr.width]="size" [attr.height]="size" fill="currentColor" viewBox="0 0 20 20">
